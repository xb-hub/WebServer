...
static xb::ConfigVar<int>::ptr g_tcp_connect_timeout = xb::Config::LookUp("tcp.connect.timeout", "tcp connect timeout", 5000);
...
unsigned int sleep(unsigned int seconds) {
    ...
    iom->addTimer(seconds * 1000, std::bind((void(xb::Scheduler::*)
            (xb::Coroutine::ptr, int thread))&xb::IOManager::addTask
            ,iom, fiber, -1));
...
int usleep(useconds_t usec) {
    ...
    xb::Coroutine::ptr fiber = xb::Coroutine::GetThis();
    xb::IOManager* iom = xb::IOManager::GetThis();
    iom->addTimer(usec / 1000, std::bind((void(xb::Scheduler::*)
            (xb::Coroutine::ptr, int thread))&xb::IOManager::addTask
            ,iom, fiber, -1));
    xb::Coroutine::Yield2Hold();
    return 0;
...
int nanosleep(const struct timespec *req, struct timespec *rem) {
    ...
    xb::Coroutine::ptr fiber = xb::Coroutine::GetThis();
    xb::IOManager* iom = xb::IOManager::GetThis();
    iom->addTimer(timeout_ms, std::bind((void(xb::Scheduler::*)
            (xb::Coroutine::ptr, int thread))&xb::IOManager::addTask
            ,iom, fiber, -1));
    xb::Coroutine::Yield2Hold();
    return 0;
