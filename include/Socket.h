 ...
 * @brief Socket封装类
 */
class Socket : public std::enable_shared_from_this<Socket>, public boost::noncopyable {
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(xb::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(xb::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(xb::Address::ptr address);
